...
[![checkStyleBadge](https://img.shields.io/badge/checkstyle%2010.11.0-passing-brightgreen)](https://checkstyle.sourceforge.io/)
...
### 🪶 Apache Maven
- #### Versión recomendada
    🟢 [Apache Maven 3.9.2](https://maven.apache.org/download.cgi) *(o más reciente)*
