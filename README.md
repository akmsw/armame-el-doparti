...
[![checkStyleBadge](https://img.shields.io/badge/checkstyle%2010.12.3-passing-brightgreen)](https://checkstyle.sourceforge.io/)
...
### 🪶 Apache Maven
- #### Versión recomendada
    🟢 [Apache Maven 3.9.3](https://maven.apache.org/download.cgi) *(o más reciente)*
